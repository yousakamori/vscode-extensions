...
function getSuggestionForDataSourceField(block, lines, position) {
    // create deep copy
    let suggestions = (0, klona_1.klona)(completionUtils_1.supportedDataSourceFields);
    const datasourceProvider = (0, util_1.getFirstDatasourceProvider)(lines);
    const previewFeatures = (0, util_1.getAllPreviewFeaturesFromGenerators)(lines);
    const isPostgresExtensionsAvailable = Boolean(datasourceProvider && datasourceProvider.includes('postgres') && (previewFeatures === null || previewFeatures === void 0 ? void 0 : previewFeatures.includes('postgresqlextensions')));
    const isMultiSchemaAvailable = Boolean(datasourceProvider &&
        (datasourceProvider.includes('postgres') ||
