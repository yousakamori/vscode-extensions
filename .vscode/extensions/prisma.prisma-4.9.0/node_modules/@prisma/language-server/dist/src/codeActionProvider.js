...
function quickFix(textDocument, params) {
    ...
    const actionDataFromPrismaFmt = prisma_fmt_wasm_1.default.code_actions(textDocument.getText(), JSON.stringify(params));
    // For debugging
    // console.log({ actionDataFromPrismaFmt })
    const codeActions = JSON.parse(actionDataFromPrismaFmt);
